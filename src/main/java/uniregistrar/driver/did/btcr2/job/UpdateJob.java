...
public record UpdateJob(String btcr2Update, String updateSignPayload, String unsignedBeaconSignal, List<String> utxoSingletonSignPayloads, List<String> utxoAggregateSignPayloads, String aggregationCohortId) {
